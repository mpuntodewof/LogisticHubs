...
|--------|------:|---------------|
| 🎬 **Demo-ready** | **85%** | 2026-04-28 (after 5.6 PPN Output summary) |
| 🚢 **Ship-ready (solid product)** | **52%** | 2026-04-28 |
...
| 4. Close the Books | 80% | 50% | Balance sheet not built; e-Faktur not audited; PPN Input pending PurchaseInvoice (2.13). Margin + PPN Output shipped 2026-04-28. |
